      ...
      <div className="container  mx-auto px-4">
        ...
        <div className="text-center mb-16 space-y-4 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            We're on a mission to transform lives through quality programming
            education. Learn from industry experts and join a community of
            passionate learners.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <Card
              key={index}
              className="text-center hover:border-primary transition-all"
            >
        ...
        <div className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((value, index) => (
              <Card
                key={index}
                className="hover:shadow-xl transition-all border-border hover:border-primary group"
              >
                <CardHeader>
        ...
        <Card className="mb-16 border-border">
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            <p>
              TakeYouUp was founded in 2020 with a simple yet powerful vision:
              to make programming education accessible to everyone. What started
              as a small online tutoring service has grown into a comprehensive
              learning platform serving thousands of students worldwide.
            </p>
            <p>
              Our founders, experienced software engineers from top tech
              companies, recognized a gap in the market for high-quality,
              practical programming education. They combined their industry
              expertise with a passion for teaching to create courses that not
              only teach theory but also focus on real-world application.
            </p>
            <p>
              Today, we're proud to offer a wide range of courses covering
              everything from programming fundamentals to advanced topics in
              machine learning and system design. Our commitment to excellence
              and student success drives everything we do.
            </p>
          </CardContent>
        </Card>
