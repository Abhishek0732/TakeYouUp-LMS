 ...
 */
export default function MarkdownEditor({ value, onChange, rows = 12, placeholder, hint }: MarkdownEditorProps) {
  ...
  return (
    <div>
      ...
      <p className="mt-1.5 text-[11px] opacity-55">
        {hint || "Markdown supported — ``` fences for code, ## headings, - lists, **bold**, `inline code`."}
      </p>
    </div>
  );
}
